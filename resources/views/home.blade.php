...
<header class="absolute inset-x-0 top-0 z-50">
    <nav class="flex items-center justify-between p-6 lg:px-8">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end gap-x-6">
            <button command="show-modal" commandfor="dialog" class="text-sm font-semibold text-white hover:text-indigo-400 cursor-pointer">
                Log in →
            </button>
        </div>
    </nav>
...
@section('content')
<!-- Home Section -->
<section class="h-screen flex items-center justify-center relative section">
    ...
    <div class="max-w-2xl text-center relative z-10">
        ...
        <div class="mt-10 flex justify-center gap-x-6">
            <button command="show-modal" commandfor="dialog" class="rounded-md bg-indigo-500 px-4 py-2 text-white font-semibold hover:bg-indigo-400 cursor-pointer">
                Get started
            </button>
            <button onclick="showSection('learnmore')"
...
<!-- Learn More -->
<section id="learnmore" class="hidden min-h-screen flex items-center justify-center bg-black/80 px-6 section">
            ...
            <el-dialog-panel class="relative transform overflow-hidden rounded-lg bg-gray-800 text-left shadow-xl outline -outline-offset-1 outline-white/10 transition-all data-closed:translate-y-4 data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in sm:my-8 sm:w-full sm:max-w-lg data-closed:sm:translate-y-0 data-closed:sm:scale-95">
                <div id="roleSelection" class="p-8 mx-auto">
                    ...
                    <div class="flex justify-end mb-4">
                        <button command="close" commandfor="dialog" class="text-gray-400 hover:text-rose-500 focus:outline-none cursor-pointer">
                    ...
                    <div class="mt-6 space-y-6">
                        <div>
                            ...
                            <a href="/login/sg" class="block w-full text-center bg-gradient-to-r from-teal-600 to-blue-600 text-white p-4 rounded-md text-md font-semibold shadow cursor-pointer transform transition-transform hover:scale-105">
                        ...
                        <div>
                            ...
                            <a href="/login/admin" class="block w-full text-center bg-gradient-to-r from-purple-700 to-indigo-600 text-white p-4 rounded-md text-md font-semibold shadow cursor-pointer transform transition-transform hover:scale-105">
                    ...
                    <div class="mt-6 text-center space-y-3">
                        <a class="block text-sm text-green-400 transition-colors duration-300 hover:text-green-300 underline cursor-pointer">
                            New here? Start your application
                        </a>
                        <a class="block w-full bg-green-600 transition-colors duration-300 hover:bg-green-500 text-white p-2 rounded-md text-sm font-medium cursor-pointer">
                            Applicant Login
                        </a>
                    </div>
                </div>

...
<body class="bg-gray-100 min-h-screen flex">
        ...
        <div class="p-5 border-b border-gray-700">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <div id="profileRole" class="text-xs text-gray-300 mt-1">Admin</div>
        ...
        <div class="p-6 flex-1">
            ...
            <div id="dashboard" class="content-section active">
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h1 class="text-2xl font-bold text-gray-800 mb-2">Admin Management Dashboard</h1>
            ...
            <div id="guard-mgmt" class="content-section">
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <h1 class="text-2xl font-bold text-gray-800 mb-6">Security Guard Management</h1>
                    <p class="text-gray-600">Manage security guard profiles, schedules, and performance.</p>
                </div>
            </div>
    ...
    <script>
        ...
        function showSection(sectionId) {
            ...
            // Add active class to clicked button (its parent)
            ...
            if (window.innerWidth < 1024) {
                ...
                document.querySelector('#sidebar-toggle i').classList.add('fa-bars');
            }
        }
        ...
        document.addEventListener('click', function(event) {
            ...
            if (window.innerWidth < 1024 &&
                ...
                !sidebar.classList.contains('-ml-64')) {
        ...
        document.getElementById('popup-modal').addEventListener('click', function(e) {
            if (e.target.id === 'popup-modal') hidePopup();
        });

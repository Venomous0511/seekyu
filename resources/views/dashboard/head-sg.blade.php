@extends('layouts.app')
@section('title', 'SeekYu - Head Security Guard Dashboard')
@section('content')
<section class="min-h-screen flex flex-col">
    <header class="bg-gray-800 text-white p-4 flex justify-between items-center">
        <h1 class="text-2xl font-bold">Head Security Guard Dashboard</h1>
    ...
    <main class="flex-grow p-6 bg-gray-900 text-white">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-gray-800 p-4 rounded-lg shadow">
                <h3 class="text-lg font-semibold mb-2">Total Security Guards</h3>
                <p class="text-3xl font-bold">45</p>
            </div>
            <div class="bg-gray-800 p-4 rounded-lg shadow">
                <h3 class="text-lg font-semibold mb-2">Active Assignments</h3>

...
@section('title', 'SeekYu - Admin Dashboard')
...
@section('content')
    ...
    <section class="dashboard-section p-10 m-6 bg-white rounded-lg shadow-md hidden" id="account-management-section">
        ...
        <div id="create-account">
            <form class="grid grid-cols-1 md:grid-cols-2 gap-4" action="{{ route('admin.accounts.store') }}" method="POST">
                @csrf
    ...
    <section class="dashboard-section p-10 m-6 bg-white rounded-lg shadow-md hidden" id="guard-management">
        <h2 class="text-2xl font-bold mb-6">Guard Management</h2>
        <p class="text-gray-600">Guard Management functionality coming soon...</p>
    </section>

    {{-- Client Management Section --}}
    <section class="dashboard-section p-10 m-6 bg-white rounded-lg shadow-md hidden" id="client-management">
        <h2 class="text-2xl font-bold mb-6">Client Management</h2>
        <p class="text-gray-600">Client Management functionality coming soon...</p>
    </section>
    ...
    <section class="dashboard-section p-10 m-6 bg-white rounded-lg shadow-md hidden" id="system-reports">
        <h2 class="text-2xl font-bold mb-6">System Reports</h2>
        <p class="text-gray-600">System Reports functionality coming soon...</p>
    </section>

    {{-- Activity Logs Section --}}
    <section class="dashboard-section p-10 m-6 bg-white rounded-lg shadow-md hidden" id="activity-logs">
        <h2 class="text-2xl font-bold mb-6">Activity Logs</h2>
        <p class="text-gray-600">Activity Logs functionality coming soon...</p>
    </section>

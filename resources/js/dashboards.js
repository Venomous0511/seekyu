...
function initializeSearch() {
    ...
    searchInputs.forEach((input) => {
        input.addEventListener("input", function () {
            ...
            // Find the closest wrapper that contains both search and table
            const wrapper = this.closest("#view-accounts");
...
function initializeRefresh() {
    document.querySelectorAll("#view-accounts button").forEach((button) => {
